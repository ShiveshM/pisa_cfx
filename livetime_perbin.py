...
if __name__ == '__main__':
    ...
    template_maker = DistributionMaker('settings/pipeline/example_cfx.cfg')
    ...
    for idx, lt in enumerate(livetimes):
        ...
        # for x in xrange(5):
            ...
            fe.append(div)
        mean.append(np.mean(fe, axis=0).flatten())
    ...
    fig.savefig('./images/perbin/greco.png', bbox_inches='tight', dpi=150)
